...
export function buildSystemPrompt(params: {
  ...
  sections.push(
    [
      ...
      "  so you actually message the user when it's due. For RECURRING duties ('every morning…',",
      "  'each Monday…') call `schedule_routine` instead; `list_schedules` shows everything scheduled",
      "  and `cancel_schedule` stops an item when the user asks.",
