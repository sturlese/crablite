...
- **It behaves like a chat native.** You see *typing…* while it works (also during proactive turns),
  it marks your messages read, it can **react with an emoji** instead of sending filler text
  (👍 to a "thanks" — then stays quiet), and in groups it replies quoting the message it answers.
